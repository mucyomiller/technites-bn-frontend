...
const accommodation2 = {
  services: [{ service: 'testing service' }],
  amenities: [{ amenity: 'amenity 1' }],
  images: [{}, {}],
  accommodation_name: 'park inn',
  location: '2',
  description: 'acc description'
};

export const token =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._fvFcTCo7YdJ1yL_X_iVFOrby5k5b3bcrOb0f9DQpEo';
